                    ...
                    var node = $(` <div class="item-row clearfix" id = ${newArr[i].id}> 
                        ...
                        <div class="col col-img">  
                            <a href="//item.mi.com/${newArr[i].id}.html" target="_blank"> 
                                <img alt="" src="${newArr[i].img}" width="80" height="80"> 
                            </a>  
                        </div> 
                        ...
                        <div class="col col-total"> 
                            ${arr[i].price[0].now} * newArr[i].num).toFixed(1)}元 
                            <p class="pre-info">  </p> 
                        </div> 
            ...
            success: function(obj){
                ...
                for(var i = 0; i < arr.length; i++){
                    ...
                    <dl> 
                        <dt> 
                            <a href="#"> 
                                <img src="${arr[i].img}" srcset="//i1.mifile.cn/a1/pms_1551867177.2478190!280x280.jpg  2x" alt="小米净水器1A（厨下式）"> 
                            </a> 
                        </dt> 
                        ...
                        <dd class="xm-recommend-price">${arr[i].price[0].now}元</dd> 
                        <dd class="xm-recommend-tips">   好评    
